...
export const UserDetailData = () => {
  ...
  //TODO: всю логику с нотификацией ошибки вынести в отдельный хук, чтобы можно было вызывать наподобие tanstack, вызывать через портал и вшить дефолтный таймер
  useEffect(() => {
    if (isError) {
